...
class blaise_ast_generic_memory_location {
   std::string _name;
...
class blaise_ast_variable : public blaise_ast_generic_memory_location {
   public:
   blaise_ast_variable(const gasp::common::token<gasp::blaise::blaise_token_type>& identifier, 
                   const gasp::common::token<gasp::blaise::blaise_token_type>& type);
...
class blaise_ast_constant : public blaise_ast_generic_memory_location {
   public:
   blaise_ast_constant(const gasp::common::token<gasp::blaise::blaise_token_type>& identifier, 
                   const gasp::common::token<gasp::blaise::blaise_token_type>& type);
...
class blaise_ast_subroutine_parameter : public blaise_ast_generic_memory_location {
   public:
   blaise_ast_subroutine_parameter(const gasp::common::token<gasp::blaise::blaise_token_type>& identifier, 
                   const gasp::common::token<gasp::blaise::blaise_token_type>& type);
