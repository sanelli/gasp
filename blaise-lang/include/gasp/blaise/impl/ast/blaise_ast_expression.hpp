...
class blaise_expression {
   ...
   public:
      blaise_expression(blaise_ast_expression_type expression_type, blaise_ast_type result_type);
...
class blaise_expression_integer_value : public blaise_expression_value<blaise_ast_expression_type::LITERAL_INTEGER,blaise_ast_type::INTEGER, int> {
   public: 
      blaise_expression_integer_value(int value) : blaise_expression_value(value) {}
   };
class blaise_expression_float_value : public blaise_expression_value<blaise_ast_expression_type::LITERAL_FLOAT, blaise_ast_type::FLOAT, float> { 
      public: 
      blaise_expression_float_value(float value) : blaise_expression_value(value) {}
};
class blaise_expression_double_value : public blaise_expression_value<blaise_ast_expression_type::LITERAL_DOUBLE, blaise_ast_type::DOUBLE, double> { 
      public: 
      blaise_expression_double_value(double value) : blaise_expression_value(value) {}
};
class blaise_expression_char_value : public blaise_expression_value<blaise_ast_expression_type::LITERAL_CHAR, blaise_ast_type::CHAR, char> { 
      public: 
      blaise_expression_char_value(char value) : blaise_expression_value(value) {}
};
class blaise_expression_string_value : public blaise_expression_value<blaise_ast_expression_type::LITERAL_STRING, blaise_ast_type::STRING, std::string> { 
      public: 
      blaise_expression_string_value(std::string value) : blaise_expression_value(value) {}
};
class blaise_expression_boolean_value : public blaise_expression_value<blaise_ast_expression_type::LITERAL_BOOLEAN, blaise_ast_type::BOOLEAN, bool> { 
      public: 
