...
class blaise_ast_expression {
   blaise_ast_type _result_type;
   blaise_ast_expression_type _expression_type;

   public:
      blaise_ast_expression(blaise_ast_expression_type expression_type, blaise_ast_type result_type);
...
public:
   blaise_ast_expression_subroutine_call(gasp::common::token<gasp::blaise::blaise_token_type> subroutine_name_token,
...
public:
   blaise_ast_expression_binary(std::shared_ptr<blaise_ast_expression> left,
...
public:
   blaise_ast_expression_unary(gasp::common::token<gasp::blaise::blaise_token_type> token_operator, 
...
public:
   blaise_ast_expression_memory_location(std::shared_ptr<blaise_ast_generic_memory_location> variable);
...
class blaise_ast_expression_value : public blaise_ast_expression {
   TValue _value;
   public:
      blaise_ast_expression_value(TValue value) 
            : blaise_ast_expression(TExpressionType, TType), _value(value) {}
...
class blaise_ast_expression_integer_value : public blaise_ast_expression_value<blaise_ast_expression_type::LITERAL_INTEGER,blaise_ast_type::INTEGER, int> {
   public: 
      blaise_ast_expression_integer_value(int value) : blaise_ast_expression_value(value) {}
   };
class blaise_ast_expression_float_value : public blaise_ast_expression_value<blaise_ast_expression_type::LITERAL_FLOAT, blaise_ast_type::FLOAT, float> { 
      public: 
      blaise_ast_expression_float_value(float value) : blaise_ast_expression_value(value) {}
};
class blaise_ast_expression_double_value : public blaise_ast_expression_value<blaise_ast_expression_type::LITERAL_DOUBLE, blaise_ast_type::DOUBLE, double> { 
      public: 
      blaise_ast_expression_double_value(double value) : blaise_ast_expression_value(value) {}
};
class blaise_ast_expression_char_value : public blaise_ast_expression_value<blaise_ast_expression_type::LITERAL_CHAR, blaise_ast_type::CHAR, char> { 
      public: 
      blaise_ast_expression_char_value(char value) : blaise_ast_expression_value(value) {}
};
class blaise_ast_expression_string_value : public blaise_ast_expression_value<blaise_ast_expression_type::LITERAL_STRING, blaise_ast_type::STRING, std::string> { 
      public: 
      blaise_ast_expression_string_value(std::string value) : blaise_ast_expression_value(value) {}
};
