...
class blaise_statement_assignment : public blaise_statement {
   ...
   friend std::shared_ptr<blaise_statement> make_assignement_statement(unsigned int line, unsigned int column,
                  std::shared_ptr<blaise_generic_memory_location> variable, 
                  std::shared_ptr<blaise_expression> expression);
};
std::shared_ptr<blaise_statement> make_assignement_statement(unsigned int line, unsigned int column,
                  std::shared_ptr<blaise_generic_memory_location> variable, 
                  std::shared_ptr<blaise_expression> expression);
