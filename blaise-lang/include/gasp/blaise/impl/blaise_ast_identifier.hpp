...
protected:
   blaise_ast_identifier(const gasp::common::token<gasp::blaise::blaise_token_type>& reference,
...
class blaise_ast_variable_identifier : public blaise_ast_identifier {
   ...
   blaise_ast_variable_identifier(const gasp::common::token<gasp::blaise::blaise_token_type>& reference,
...
class blaise_ast_array_identifier : public blaise_ast_identifier {
   ...
   std::shared_ptr<blaise_ast_expression> _indexing_expression;
    blaise_ast_array_identifier(const gasp::common::token<gasp::blaise::blaise_token_type>& reference,
                                 std::shared_ptr<blaise_ast_generic_memory_location> variable,
