...
// EXPRESSION
// 
blaise_expression::blaise_expression(blaise_ast_expression_type expression_type, blaise_ast_type result_type) 
   :  _expression_type(expression_type), _result_type(result_type){ }
blaise_ast_type blaise_expression::result_type() const { return _result_type; }
blaise_ast_expression_type blaise_expression::expression_type() const { return _expression_type; }
...
blaise_expression_subroutine_call::blaise_expression_subroutine_call(
      ...
      const vector<shared_ptr<blaise_expression>>& expressions)
         : blaise_expression(blaise_ast_expression_type::FUNCTION_CALL, subroutine->return_type()),
...
shared_ptr<blaise_expression_subroutine_call> gasp::blaise::ast::blaise_expression_subroutine_call_factory(
   token<blaise_token_type> subroutine_name_token,
   shared_ptr<blaise_subroutine> subroutine,
   const vector<shared_ptr<blaise_expression>>& expressions){
...
) : blaise_expression(blaise_ast_expression_type::BINARY, blaise_ast_utility::get_resulting_type(token_operator, left->result_type(), right->result_type())),
...
std::shared_ptr<blaise_expression_binary> gasp::blaise::ast::blaise_expression_binary_factory(
...
blaise_expression_unary::blaise_expression_unary(gasp::common::token<gasp::blaise::blaise_token_type> token_operator, 
   ...
   : blaise_expression(blaise_ast_expression_type::UNARY, blaise_ast_utility::get_resulting_type(token_operator, operand->result_type())),
...
std::shared_ptr<blaise_expression_unary> gasp::blaise::ast::blaise_expression_unary_factory(gasp::common::token<gasp::blaise::blaise_token_type> token_operator,
                        std::shared_ptr<blaise_expression> operand) {
...
blaise_expression_memory_location::blaise_expression_memory_location(shared_ptr<blaise_generic_memory_location> memory_location) 
   : blaise_expression(blaise_ast_expression_type::MEMORY_LOCATION, memory_location->type()), _memory_location(memory_location) { 
...
std::shared_ptr<blaise_expression_memory_location> gasp::blaise::ast::blaise_expression_memory_location_factory(const std::shared_ptr<blaise_subroutine>& subroutine, token<blaise_token_type> token){
   switch(token.type()) {
...
// LITERAL
//
shared_ptr<blaise_expression> gasp::blaise::ast::blaise_expression_value_factory(token<blaise_token_type> token){
   switch(token.type()){
