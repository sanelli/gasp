...
void gasp::blaise::blaise_parser_context::module(std::shared_ptr<ast::blaise_module> module){
   _module = module;
}
std::shared_ptr<ast::blaise_module> gasp::blaise::blaise_parser_context::module() const {
   return _module;
}
