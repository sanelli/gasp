...
class torricelly_debugger_command_stop : public torricelly_debugger_command
{
public:
   torricelly_debugger_command_stop(std::shared_ptr<torricelly_debugger> debugger);
   virtual ~torricelly_debugger_command_stop();
