...
class blaise_parser : public sanelli::parser<blaise_token_type>
{
   ...
   static void inline parse_subroutine_signature(blaise_parser_context &context,
                                                 blaise_token_type expected_token_type,
   ...
   static std::shared_ptr<ast::blaise_ast_statement> parse_delete_statement(blaise_parser_context &context);
