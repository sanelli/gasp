...
int torricelly_subroutine::add_parameter(std::shared_ptr<torricelly::torricelly_type> type){
   _parameters.push_back(type);
   return _parameters.size() - 1;
}
int torricelly_subroutine::add_variable(std::shared_ptr<torricelly::torricelly_type> type) {
