...
int8_t to_binary(torricelly_type_type type);
int8_t to_binary(torricelly_system_type_type type);
...
torricelly_type_type torricelly_type_type_from_binary(int8_t byte);
torricelly_system_type_type torricelly_system_type_type_from_binary(int8_t byte);
