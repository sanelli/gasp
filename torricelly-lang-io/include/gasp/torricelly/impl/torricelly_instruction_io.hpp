...
torricelly_binary_input &operator>>(torricelly_binary_input &is, torricelly_inst_ref_type &inst_ref_type);
torricelly_binary_input &operator>>(torricelly_binary_input &is, torricelly_instruction &instruction);
