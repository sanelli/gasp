...
void execute_pop_byte(const torricelly::torricelly_instruction& instruction);
void execute_pop_short(const torricelly::torricelly_instruction& instruction);
void execute_pop_integer(const torricelly::torricelly_instruction& instruction);
void execute_pop_long(const torricelly::torricelly_instruction& instruction);
