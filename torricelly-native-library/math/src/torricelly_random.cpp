...
extern "C" void random_integer_(std::vector<interpreter::torricelly_activation_record_local> &stack)
{
...
extern "C" void random_char_(std::vector<interpreter::torricelly_activation_record_local> &stack)
{
...
extern "C" void random_boolean_(std::vector<interpreter::torricelly_activation_record_local> &stack)
{
...
extern "C" void random_float_(std::vector<interpreter::torricelly_activation_record_local> &stack)
{
...
extern "C" void random_double_(std::vector<interpreter::torricelly_activation_record_local> &stack)
{
